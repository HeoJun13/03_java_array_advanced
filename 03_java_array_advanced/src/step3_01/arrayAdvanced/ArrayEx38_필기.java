...
public class ArrayEx38_필기 {
	...
	public static void main(String[] args) {
		...
		System.out.print("1번째 번호 입력: ");
		int idx1 = scan.nextInt();
		System.out.print("2번째 번호 입력: ");
		...
		System.out.println("인덕스1 : " + idx1);
		System.out.println("인덕스2 : " + idx2);
